...
public:
    ...
    void visitImpl(QueryTreeNodePtr & node) const
    {
        ...
        const auto new_node = generateOptimizedDateFilter(*function, *column_id, *preimage_range);
...
private:
    QueryTreeNodePtr generateOptimizedDateFilter(const FunctionNode & comparator_node, const ColumnNode & column_node, const std::pair<Field, Field>& range) const
    {
        ...
        String comparator = comparator_node.getFunctionName();
